...
@RestController // 각각 메서드 마다 @responseBody를 안붙여도 됨
...
public class ReplyController {
	...
	public Map<String, Object> getList(@PathVariable int bno,@PathVariable int pageNum) { // url에 쓸 변수 지정
	...
	@DeleteMapping("/{rno}")
	public String delete(@PathVariable int rno, @RequestBody ReplyDeleteDTO dto) {
		dto.setReplyNo(rno);
