    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-9 write-wrap">
                        ...
                        <form action="${pageContext.request.contextPath}/freeboard/freeModify" method="post" name="updateForm">
                     ...
                     <!-- form태그안에서 submit은 한번밖에 안되므로 자바스크립트를 이용 -->
                </div>
            </div>
        </div>
        </section>
        ...
        <script>
			...
			document.getElementById('update-btn').onclick = function(){
                ...
                if($form.title.value === '') { // updateForm이라는 폼 태그 안쪽에 name = title이라는 input태그안쪽에 아무것도 안써있냐?
                        alert('제목은 필수 항목입니다.');   
                        return;
            ...
            document.getElementById('del-btn').onclick = () => {
                if(confirm('정말 삭제하시겠습니까?')) { // confirm 확인(true)과 취소(false)가 있는 알림창.
                    // 확인(true)누르면 실행
