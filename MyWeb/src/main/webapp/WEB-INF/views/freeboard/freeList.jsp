                        ...
                        <tbody>
                        	<c:forEach var="vo" items="${boardList}">
	                            <tr>
	                                <td>${vo.bno}</td>
	                                <td>
	                                <a href="/myweb/freeboard/freeContent?bno=${vo.bno}&pageNo=${pc.page.pageNo}&amount=${pc.page.amount}&keyword=${pc.page.keyword}&condition=${pc.page.condition}">${vo.title}</a>
	                                </td>
	                                <td>${vo.writer}</td>
	                                <td>${vo.date}</td>
	                            </tr>
